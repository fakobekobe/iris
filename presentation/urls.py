...
urlpatterns = [
    ...
    path('retour-liste-membre/<str:id>', views.retour_liste_membre, name='retour_liste_membre'),
    ...
    path('detail-parent-secteuragricole/<str:id>/<str:id_retour>', views.detail_parent_secteuragricole, name='detail_parent_secteuragricole'),
