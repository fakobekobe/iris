$(document).ready(function() {
    ...
    var table_recherche_cooperative = "table_recherche_cooperative";
    var table = $('#' + table_recherche_cooperative ).DataTable( {
   ...
   /* "columnDefs":[{
    ...
    var monTableau = $('#'+ table_recherche_cooperative).DataTable(); // On récupère le tableau
    $('#recherche_cooperative').keyup(function(){
